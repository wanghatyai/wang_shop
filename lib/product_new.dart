...
class _ProductNewPageState extends State<ProductNewPage> {
  ...
  getProduct() async{
    ...
    final res = await http.get(Uri.https('wangpharma.com', '/API/product.php', {'PerPage': perPage.toString(), 'act':'New'}));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("สินค้าใหม่", style: TextStyle(color: Colors.deepOrange),),
        actions: <Widget>[
          IconButton(
